 ...
 * @since 3.0.0-M4
 */
public final class ForkedProcessEventObserver
{
    ...
    private final ConcurrentMap<ForkedProcessEventType, ForkedProcessStandardOutErrEventListener> stdOutErrEventListeners =
            new ConcurrentHashMap<>();
