 ...
 * @since 3.0.0-M5
 */
public abstract class AbstractTestControlEvent extends Event
{
    private final RunMode runMode;
    private final ReportEntry reportEntry;

    public AbstractTestControlEvent( ForkedProcessEventType eventType, RunMode runMode, ReportEntry reportEntry )
    {
        super( eventType );
